...
$app->get('/session', function() {
	...
	$response["mailinglist"] = $session['mailinglist'];
...
$app->post('/login', function() use ($app) {
    ...
    if ($user != NULL) {
		...
		$response['mailinglist'] = $user['mailinglist'];
        if (!isset($_SESSION)) {
            session_start();
        }
...
$app->post('/signUp', function() use ($app) {
    ...
    if(!$isUserExists){
        ...
        $column_names = array('phone', 'gender', 'name', 'firstname', 'email', 'password', 'city', 'address', 'mailinglist');
